        ...
        child: Stack(
          children: [
            ...
            ModelViewer(
              ...
              autoRotate: false,
              cameraControls:
                  false, // Disable free movement - rotation only via button
              disableZoom: true,
              disableTap: true,
              interpolationDecay: 200,
              // Fixed camera position with controlled rotation
            ...
            // Control button positioned on the right side
            if (!_isLoading)
              Positioned(
                top: 16,
                right: 16,
